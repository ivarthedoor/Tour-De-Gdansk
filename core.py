...
class GameCore:
    def __init__(self):
        ...
        self.task_assingment_positions = [i - 1 for i in get_board_range() if i % 5 == 0]
    ...
    def questions_assingment(self, position, points_index):  # Losowanie pytania co piąte pole 
